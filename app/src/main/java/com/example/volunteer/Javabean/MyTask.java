...
public class MyTask extends BmobObject {
     ...
     */
        ...
        public MyTask(){}
        public  MyTask(String startTime,String phone,String picture,String title,String content,String publishTime,String place,
    ...
    public void setIsexed(Boolean isexed) {
        this.isexed = isexed;
    }
