...
public class FlyBanner extends RelativeLayout {
    //MATCH_PARENT意味着视图希望与其父级一样大，减去父级的填充（如果有的话）。在API Level 8中引入。
    private static final int RMP = RelativeLayout.LayoutParams.MATCH_PARENT;
    //WRAP_CONTENT意味着视图要足够大以适应其自己的内部内容，并考虑自己的填充
    private static final int RWP = RelativeLayout.LayoutParams.WRAP_CONTENT;
    ...
    private void setLayout(Context context) {
        ...
        //设定指示器容器布局及位置
        RelativeLayout.LayoutParams pointContainerLp = new RelativeLayout.LayoutParams(RMP, RWP);
