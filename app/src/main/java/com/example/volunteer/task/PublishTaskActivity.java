...
import com.example.volunteer.shuoshuo.ScreenSizeUtils;
...
public class PublishTaskActivity extends AppCompatActivity {
    ...
    private void popDialog(){
        picture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Dialog dialog = new Dialog(PublishTaskActivity.this,R.style.normalDialogAnim);
                View view = View.inflate(PublishTaskActivity.this, R.layout.dialog_bottom, null);
                dialog.setContentView(view);
                dialog.setCanceledOnTouchOutside(true);
                view.setMinimumHeight((int) (ScreenSizeUtils.getInstance(PublishTaskActivity.this).getScreenHeight() * 0.23f));
                Window dialogWindow = dialog.getWindow();
                WindowManager.LayoutParams lp = dialogWindow.getAttributes();
                lp.width = (int) (ScreenSizeUtils.getInstance(PublishTaskActivity.this).getScreenWidth() * 0.9f);
    ...
    private void exeTakePhoto(){
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            ImageUri = FileProvider.getUriForFile(PublishTaskActivity.this,
    ...
    private void exechooseFromAlbum(){
        ...
        if (ContextCompat.checkSelfPermission(PublishTaskActivity.this,
                android.Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager
                        /*用于检索与应用程序相关的各种信息的类*/.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions/*调用回调方法*/(PublishTaskActivity.this,
        ...
        switch(requestCode){//requestCode 就是Activity.compat()中的最后一个参数
            case 1:
                if(grantResults.length>0&&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(PublishTaskActivity.this,"you denied the permission",Toast.LENGTH_SHORT).show();
                }
                break;
            default:
                break;
                       ...
                       public void done(BmobException e) {
                        Log.d("是否正确",(e!=null)+"");
                           if (e == null) {
                               ...
                               uriStr=bmobFile.getUrl();



                               task.setPicture(uriStr);
